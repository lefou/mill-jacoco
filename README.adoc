...
You can override the `jacocoVersion` task or define the `JACOCO_VERSION` environment variable.
...
If you want to collect more than one data set, e.g. to separate unit test and integration test coverage, you can define your own modules
